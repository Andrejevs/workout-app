...
import com.eugene.wp.data.WorkOut;
...
@Data
public class AddTrainingWorkoutTaskController implements ITaskController {
    private final WorkOut element;
    ...
    public AddTrainingWorkoutTaskController(WorkOut element, AddTrainingLogic logic,
